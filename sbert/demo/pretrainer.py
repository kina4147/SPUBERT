...
from SocialBERT.sbert.model.pretrainer import SBertPTTrainer
...
def trainer():
    ...
    trainer = SBertPTTrainer(train_dataloader=train_dataloader, val_dataloader=val_dataloader, args=args, tb_writer=tb_writer)
