...
class SPUBERTTrainer(object):
    ...
    def __init__(self, train_dataloader=None, tb_writer=None, args=None):
    ...
    def test(self, epoch, data_loader, d_sample, k_sample):
        ...
        with torch.no_grad():
            ...
            for i, it_data in data_iter:
                ...
                gderror, aderror, fderror = bom_loss_3(outputs["pred_goals"], outputs["pred_trajs"], data["goal_lbl"], data["traj_lbl"], k_sample)
