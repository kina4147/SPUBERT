...
from SocialBERT.sbertplus.model.sbertplus import (
    SBertPlusTGPConfig, SBertPlusMGPConfig, SBertPlusFTConfig, SBertPlusFTModel
)
from SocialBERT.sbertplus.model.loss import bom_loss_1, bom_loss_3, goal_collision_loss, pos_collision_loss
...
def trainer():
    ...
    sbert_tgp_cfgs = SBertPlusTGPConfig(
    ...
    sbert_mgp_cfgs = SBertPlusMGPConfig(
                input_dim=args.input_dim, output_dim=args.output_dim, goal_dim=args.goal_dim,
    ...
    sbert_cfgs = SBertPlusFTConfig(traj_cfgs=sbert_tgp_cfgs, goal_cfgs=sbert_mgp_cfgs, share=args.share)
    
    model = SBertPlusFTModel(sbert_tgp_cfgs, sbert_mgp_cfgs, sbert_cfgs)
