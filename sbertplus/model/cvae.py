...
class GoalPriorNet(nn.Module):
    def __init__(self, enc_hidden_size, goal_latent_size, hidden_layers=[128, 64], layer_norm_eps=1e-4, dropout_prob=0.25, act_fn='relu'):
        super().__init__()
        ...
        # self.LayerNorm = nn.LayerNorm(goal_latent_size*2, eps=layer_norm_eps)
...
class GoalEncoder(nn.Module):
    def __init__(self, spatial_dim=2, goal_hidden_size=64, hidden_layers=[32, 64], layer_norm_eps=1e-4, dropout_prob=0.25, act_fn='relu'):
        ...
        self.act_fn1 = ACT2FN[act_fn]
        # self.linear2 = nn.Linear(hidden_layers[0], goal_hidden_size)
        # self.act_fn2 = ACT2FN[act_fn]
        # self.linear3 = nn.Linear(hidden_layers[1], goal_hidden_size)
