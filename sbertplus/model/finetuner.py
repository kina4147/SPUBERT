...
from SocialBERT.sbertplus.model.loss import bom_loss_1, bom_loss_2, bom_loss_3
from SocialBERT.sbertplus.util.scheduler import CyclicScherduler, frange_cycle_sigmoid, frange_cycle_cosine
transformers.logging.set_verbosity_info()

from SocialBERT.sbertplus.util.viz import *
torch.autograd.set_detect_anomaly(True)

class SBertPlusFTTrainer(SBertTrainer):
    """
    ...
    def __init__(self, train_dataloader=None, val_dataloader=None, tb_writer=None, args=None):
        ...
        self.sbert_tgp_cfgs = SBertPlusTGPConfig(
        ...
        self.sbert_mgp_cfgs = SBertPlusMGPConfig(
            input_dim=args.input_dim, output_dim=args.output_dim, goal_dim=args.goal_dim,
        ...
        self.sbert_cfgs = SBertPlusFTConfig(traj_cfgs=self.sbert_tgp_cfgs, goal_cfgs=self.sbert_mgp_cfgs, share=args.share)
        self.model = SBertPlusFTModel(self.sbert_tgp_cfgs, self.sbert_mgp_cfgs, self.sbert_cfgs) # enc share // mode freeze
