...
Preprocessing after transformations
. data augmentation
...
def get_node_timestep_data(env, scene, t, node, state, pred_state,
    ...
    return (
    first_history_index, x_t, y_t, x_st_t, y_st_t, neighbors_data, neighbors_data_st, neighbors_data_lower_upper,
    neighbors_future,
    neighbors_edge_value, robot_traj_st_t, map_tuple, scene.name, t, rel_state, std)
